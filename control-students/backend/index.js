 ...
 * @returns {{ name: string, surname: string, middlename: string, birthday: string, studyStart: string, studyEnd: string, faculty: string }} Объект студента
 */
function makeStudentFromData(data) {
    ...
    const student = {
        ...
        studyEnd: asString(data.studyEnd),
    ...
    if (!student.middlename) errors.push({ field: 'middlename', message: 'Не указано отчество' });
    ...
    if (!student.studyEnd) errors.push({ field: 'studyEnd', message: 'Не указано конец обучения' });
 ...
 * @returns {{ id: string, name: string, surname: string, middlename: string, birthday: string, studyStart: string, studyEnd: string, faculty: string }[]} Массив студентов
 */
 ...
 * @returns {{ id: string, name: string, surname: string, middlename: string, birthday: string, studyStart: string, studyEnd: string, faculty: string, createdAt: string, updatedAt: string }} Объект студента
 */
 ...
 * @param {{ name?: string, surname?: string, middlename?: string, birthday?: string, studyStart?: string, studyEnd?: string, faculty?: string }} data - Объект с изменяемыми данными
 * @throws {ApiError} Студент с таким ID не найден (statusCode 404)
 * @throws {ApiError} Некорректные данные в аргументе (statusCode 422)
 * @returns {{ id: string, name: string, surname: string, middlename: string, birthday: string, studyStart: string, studyEnd: string, faculty: string, createdAt: string, updatedAt: string }} Объект студента
 */
